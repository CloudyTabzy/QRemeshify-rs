...
class QWPropertyGroup(PropertyGroup):
    verbose_logging:    BoolProperty(name="Verbose Logging", description="Enable detailed debug output in console and Info panel. Turn OFF for normal use.", default=False)
